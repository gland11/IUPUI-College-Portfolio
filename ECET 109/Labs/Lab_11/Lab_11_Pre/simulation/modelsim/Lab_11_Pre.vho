...
-- Z	=>  Location: PIN_AB30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D	=>  Location: PIN_AC29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- C	=>  Location: PIN_W25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- B	=>  Location: PIN_AC28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A	=>  Location: PIN_AA30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SEL[0]	=>  Location: PIN_AC27,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SEL[1]	=>  Location: PIN_V25,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Lab_11_Pre IS
...
-- Equation(s):
-- \Mux0~0_combout\ = ( \D~input_o\ & ( \A~input_o\ & ( (!\SEL[0]~input_o\ & (((!\SEL[1]~input_o\) # (\B~input_o\)))) # (\SEL[0]~input_o\ & (((\SEL[1]~input_o\)) # (\C~input_o\))) ) ) ) # ( !\D~input_o\ & ( \A~input_o\ & ( (!\SEL[0]~input_o\ & (((\B~input_o\ 
-- & \SEL[1]~input_o\)))) # (\SEL[0]~input_o\ & (((\SEL[1]~input_o\)) # (\C~input_o\))) ) ) ) # ( \D~input_o\ & ( !\A~input_o\ & ( (!\SEL[0]~input_o\ & (((!\SEL[1]~input_o\) # (\B~input_o\)))) # (\SEL[0]~input_o\ & (\C~input_o\ & ((!\SEL[1]~input_o\)))) ) ) 
-- ) # ( !\D~input_o\ & ( !\A~input_o\ & ( (!\SEL[0]~input_o\ & (((\B~input_o\ & \SEL[1]~input_o\)))) # (\SEL[0]~input_o\ & (\C~input_o\ & ((!\SEL[1]~input_o\)))) ) ) )
