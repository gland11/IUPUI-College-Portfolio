...
ARCHITECTURE structure OF Lab_02_pre_ActiveLow IS
...
-- Equation(s):
-- \box~0_combout\ = ( \R~input_o\ & ( (\enable~input_o\) # (\S~input_o\) ) ) # ( !\R~input_o\ & ( \enable~input_o\ ) )
...
-- Equation(s):
-- \box~combout\ = ( \box~0_combout\ & ( \process_0~0_combout\ & ( \box~combout\ ) ) ) # ( \box~0_combout\ & ( !\process_0~0_combout\ & ( \box~combout\ ) ) ) # ( !\box~0_combout\ & ( !\process_0~0_combout\ ) )
...
-- Equation(s):
-- \Q~0_combout\ = ( \enable~input_o\ ) # ( !\enable~input_o\ & ( (!\R~input_o\) # ((\S~input_o\ & \box~combout\)) ) )
