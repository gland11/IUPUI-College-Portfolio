...
RIGHT_PULSE   = 1425  # Smaller values for 'more' right             # (1)
...
if __name__ == '__main__':
    ...
    try:
        ...
        sweep()
        MOVEMENT_DELAY_SECS=1.5
        sleep(MOVEMENT_DELAY_SECS)
        print("Motor to the Right")
        right()
        sleep(MOVEMENT_DELAY_SECS)
        print("Motor to the Left")
        left()
        sleep(MOVEMENT_DELAY_SECS)
        print("Motor to the 45")
        angle(45)
        sleep(MOVEMENT_DELAY_SECS)
        print("Motor to the -45 kinda (-88)")
        angle(-88)
        sleep(MOVEMENT_DELAY_SECS)
