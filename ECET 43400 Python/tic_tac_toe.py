...
xPhoto = PhotoImage(file = 'Purduelogothisone.png')
oPhoto = PhotoImage(file = 'IUlogo.png')

tkinter.messagebox.showinfo("Tic-Tac-Toe", 'Turn on Audio :D')
...
def checkWin():
    ...
    if (btn1.get() == 'X' and btn2.get() == 'X' and btn3.get() == 'X' or
        ...
        open_player = vlc.MediaPlayer('HailFire.mp3')
        open_player.play()
        tkinter.messagebox.showinfo("Tic-Tac-Toe", 'Purdue Wins!')
        click = True
        count = 0
        clear()
        play()
          ...
          open_player = vlc.MediaPlayer('HailFire.mp3')
          open_player.play()
          tkinter.messagebox.showinfo("Tic-Tac-Toe", 'IU Wins!')
          count = 0
          clear()
          play()
          
    elif (count == 9):
         tkinter.messagebox.showinfo("Tic-Tac-Toe", 'Purdue Wins (aka Tied)!')
         click = True
         count = 0
         clear()
         play()
